...
public class CloseEventButtonTwo {
  ...
  @Test
  public void testCloseEventButtonTwo() throws Exception {
    ...
    driver.findElement(By.xpath("//tbody[@id='calendar']/tr[2]/td[2]/div/button/b")).click();
    //driver.findElement(By.xpath("//div[@id='eventModal27']/div/div/div/button")).click();
