...
public class CreateAccountSuccess {
  ...
  public void testCreateAccountSuccess() throws Exception {
    ...
    driver.findElement(By.name("email")).sendKeys("newuser@mail.com");
    driver.findElement(By.name("username")).clear();
    driver.findElement(By.name("username")).sendKeys("newuser4");
    driver.findElement(By.name("password")).clear();
    driver.findElement(By.name("password")).sendKeys("newuser1");
    driver.findElement(By.name("repeatPassword")).clear();
    driver.findElement(By.name("repeatPassword")).sendKeys("newuser1");
