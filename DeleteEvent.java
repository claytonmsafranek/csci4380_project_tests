...
public class DeleteEvent {
  ...
  public void testDeleteEvent() throws Exception {
    ...
    driver.get("http://ec2-44-202-119-23.compute-1.amazonaws.com/app2/delete_event.html");
    driver.findElement(By.xpath("//p[4]/input")).click();
    driver.findElement(By.xpath("//input[@value='Delete Event(s)']")).click();
    driver.get("http://ec2-44-202-119-23.compute-1.amazonaws.com/app2/user_calendar.html");
  }
