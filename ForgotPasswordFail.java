...
public class ForgotPasswordFail {
  ...
  public void testForgotPasswordFail() throws Exception {
    driver.get("http://ec2-44-202-119-23.compute-1.amazonaws.com/app2/forgot_password.html");
    driver.findElement(By.id("Uname")).click();
    driver.findElement(By.id("Uname")).clear();
    driver.findElement(By.id("Uname")).sendKeys("abht");
