...
public class TodoItemMedium {
  ...
  @Test
  public void testTodoItemMedium() throws Exception {
    ...
    driver.findElement(By.name("task")).sendKeys("test todo medium");
    driver.findElement(By.name("prioritySelect")).click();
    new Select(driver.findElement(By.name("prioritySelect"))).selectByVisibleText("Medium");
